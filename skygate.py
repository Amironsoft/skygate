...
def parse_data_xml(xml_file, csv_file, term, need_download_pdf=False):
    ...
    with open(csv_file, 'w', encoding='utf-8') as ofile_stats:
...
def get_onepetro(term):
    ...
    html_files = [
                  "static/html/Gmech_14auth_data_comp.html",
                  "static/html/Gmech_14comp_data_comp.html",

                  # "static/html/Gmech_14auth_data_comp.html",
                  # "static/html/Gmech_14comp_data_comp.html",
                  #
                  # "static/html/Gmech_15auth_data_comp.html",
                  # "static/html/Gmech_15comp_data_comp.html",
                  #
                  # "static/html/Gmech_16auth_data_comp.html",
                  # "static/html/Gmech_16comp_data_comp.html",

                  "static/html/Gmech_17auth_data_comp.html",
                  "static/html/Gmech_17comp_data_comp.html",
    ]
    ...
    stats_files = []
    tsv_file_auth = "static/html/Gmech_17auth_data_degree.txt"
    tsv_file_comp = "static/html/Gmech_17comp_data_degree.txt"

    topic_file = "static/topic/topic_text_no_reg_64_64.txt"
    ans = [tsv_file_auth, tsv_file_comp, topic_file] + html_files + json_files
